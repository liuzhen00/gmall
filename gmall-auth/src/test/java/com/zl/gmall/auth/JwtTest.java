...
/**
 * @author shkstart
 * @create 2020-03-08 0:36
 */


public class JwtTest {
    private static final String pubKeyPath = "D:\\DMEO\\06project\\secret\\rsa.pub";

    private static final String priKeyPath = "D:\\DMEO\\06project\\secret\\rsa.pri";
   ...
   @Test
    ...
    public void testGenerateToken() throws Exception {
        ...
        // 生成token
        String token = JwtUtils.generateToken(map, privateKey, 20);
